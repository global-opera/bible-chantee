...
- Books 01, 02, 03: FR/ (matches actual audio)
- Books 04-66: FR_V2/
...
def main():
    ...
    print("  - Livres 01-03: FR/ (correspond à l'audio)")
    print("  - Livres 04-66: FR_V2/")
    print("="*70)
    print()
    ...
    # PART 1: Books 01-03 from FR/ (pattern: _001_, _002_, etc.)
    print("PARTIE 1: Livres 01-03 depuis FR/")
    for txt_file in sorted(SOURCE_FR.rglob("*.txt")):
        ...
        # Only take books 01, 02, 03
        if book_num not in ['01', '02', '03']:
            continue
    ...
    # PART 2: Books 04-66 from FR_V2/ (pattern: _01_, _02_, etc.)
    print("\nPARTIE 2: Livres 04-66 depuis FR_V2/")
    for txt_file in sorted(SOURCE_FR_V2.rglob("*.txt")):
        ...
        # Skip books 01, 02, 03 (already loaded from FR/)
        if book_num in ['01', '02', '03']:
            continue
    ...
    with open(OUTPUT_FILE, 'w', encoding='utf-8') as f:
        ...
        f.write("// Source: FR/ (books 01-03) + FR_V2/ (books 04-66)\n")
    ...
    print(f"  - Livres 01-03: FR/")
    print(f"  - Livres 04-66: FR_V2/")
