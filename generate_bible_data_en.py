...
# -*- coding: utf-8 -*-
"""
Génère le fichier bible-data-en.js pour le site web
Bible: King James Version (KJV) 1611 - Public Domain
"""
import json
import sys
import io
...
# Chemins
BIBLE_JSON = Path(r"G:\Mon Drive\01 BibleChantee\en_bible_kjv_1611.json")
OUTPUT_FILE = Path(r"C:\ScriptBible\bible-chantee\bible-data-en.js")

def load_bible():
    """Charge la Bible KJV 1611"""
    with open(BIBLE_JSON, 'r', encoding='utf-8') as f:
        return json.load(f)

def generate_bible_data_js():
    """Génère le fichier JavaScript avec les données bibliques EN"""
    print("Chargement de la Bible KJV 1611...")
    bible = load_bible()
    ...
    print("\nGénération du fichier bible-data-en.js...")

    js_content = "// Bible Text Data - King James Version (KJV) 1611\n"
    js_content += "// Public Domain\n"
    js_content += "// Generated automatically - Do not modify manually\n\n"
    js_content += "const bibleDataEN = " + json.dumps(bible_data, ensure_ascii=False, indent=2) + ";\n"
