...
- **`netlify.toml`** - Redirects 301 clean URLs (/promesses → /promesses.html)
...
- **`promesses-data.js`** - Données thématiques PT
...
- **JSON:** `promesses-data.js` (avec `PROMESSAS[lang]` à l'intérieur)
